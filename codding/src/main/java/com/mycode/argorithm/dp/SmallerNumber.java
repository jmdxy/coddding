package com.mycode.argorithm.dp;
...
import com.mycode.argorithm.leetcode.CountOfSmallerNumbersAfterSelf;
import com.mycode.argorithm.leetcode.LongestIncreasingSubsequence;
 ...
 * 不能用DP!!!
 * 不能用DP!!!
 * 和{@link LongestIncreasingSubsequence}思想类似的DP
 *
 * @author zhangxu
 * @see CountOfSmallerNumbersAfterSelf 这才是正确的解法
 */
@Deprecated
